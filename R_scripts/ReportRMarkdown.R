...
## @knitr NAAM
## options
PATH_RBOX02 <- '/home/lca/Documents' #Pathname has to be changed on other computer
PATH_DI06C001 <- 'C:/Users/Marilyn/Documents/Files/Werk_LCA/Pipeline_metabolomics' # professional pc van lca voor mdg
...
#path_R_scripts <- '/home/lca/lib/gedit'
...
if(RUN_PART_PREPROCEESSING == RUN_CODE){
  #rmarkdown::render(file.path(path_R_scripts, 'ReportPART1.Rmd'), output_file = file.path(path_data_report, 'ReportPART1'), output_format="html_document")
  #rmarkdown::render(file.path(path_R_scripts, 'ReportPART1.Rmd'), output_file = file.path(path_data_report, 'ReportPART1'), output_format="word_document")
  #rmarkdown::render(file.path(path_R_scripts, 'ReportPART1.Rmd'), output_file = file.path(path_data_report, 'ReportPART1'), output_format = "pdf_document")
}
...
if(RUN_PART_STATISTICAL == RUN_CODE){
  #rmarkdown::render(file.path(path_R_scripts, 'ReportRMarkdown.Rmd'), output_file = file.path(path_data_report, 'ReportRMarkdown'), output_format="html_document")
  #rmarkdown::render(file.path(path_R_scripts, 'ReportRMarkdown.Rmd'), output_file = file.path(path_data_report, 'ReportRMarkdown'), output_format="word_document")
  #rmarkdown::render(file.path(path_R_scripts, 'ReportRMarkdown.Rmd'), output_file = file.path(path_data_report, 'ReportRMarkdown'), output_format = "pdf_document")
}

if(RUN_PART_UNIVARIATE == RUN_CODE){
  rmarkdown::render(file.path(path_R_scripts, 'Report_univariate_analysis.Rmd'), output_file = file.path(path_data_report, 'Report_univariate_analysis'), output_format="html_document")
}
